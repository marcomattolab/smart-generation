...
public class ${className} extends MetricsConfigurerAdapter implements ServletContextInitializer {
    ...
    public ${className}(JHipsterProperties jHipsterProperties, CacheManager cacheManager) {
