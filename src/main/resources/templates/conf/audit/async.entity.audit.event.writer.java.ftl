...
import ${packageClass}.${srcDomainFolder}.AbstractAuditingEntity;
import ${packageClass}.${srcDomainFolder}.EntityAuditEvent;
import ${packageClass}.${srcRepositoryFolder}.EntityAuditEventRepository;
