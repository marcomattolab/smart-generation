...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Forward Program Planner');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Forward Program Planner');

      cy.get(`[data-cy="minSalary"]`).type('21545');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '21545');

      cy.get(`[data-cy="maxSalary"]`).type('32253');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '32253');
