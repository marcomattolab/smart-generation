...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('sniff');
      cy.get(`[data-cy="title"]`).should('have.value', 'sniff');

      cy.get(`[data-cy="description"]`).type('correctly boohoo');
      cy.get(`[data-cy="description"]`).should('have.value', 'correctly boohoo');
