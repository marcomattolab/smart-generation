...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('tomorrow save');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'tomorrow save');

      cy.get(`[data-cy="postalCode"]`).type('lawmaker sell yowza');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'lawmaker sell yowza');

      cy.get(`[data-cy="city"]`).type('Francesport');
      cy.get(`[data-cy="city"]`).should('have.value', 'Francesport');

      cy.get(`[data-cy="stateProvince"]`).type('management inhibit');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'management inhibit');
