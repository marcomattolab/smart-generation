...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Jettie');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Jettie');

      cy.get(`[data-cy="lastName"]`).type('Stamm');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Stamm');

      cy.get(`[data-cy="email"]`).type('Jules_Blick@hotmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Jules_Blick@hotmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('flat');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'flat');

      cy.get(`[data-cy="hireDate"]`).type('2025-08-29T16:04');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2025-08-29T16:04');

      cy.get(`[data-cy="salary"]`).type('21705');
      cy.get(`[data-cy="salary"]`).should('have.value', '21705');

      cy.get(`[data-cy="commissionPct"]`).type('27736');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '27736');
