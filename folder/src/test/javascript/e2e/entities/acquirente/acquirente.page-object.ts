...
export class AcquirenteComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    deleteButtons = element.all(by.css('jhi-acquirente div table .btn-danger'));
    title = element.all(by.css('jhi-acquirente div h2#page-heading span')).first();
...
export class AcquirenteUpdatePage {
    pageTitle = element(by.id('jhi-acquirente-heading'));
...
export class AcquirenteDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-acquirente-heading'));
    private confirmButton = element(by.id('jhi-confirm-delete-acquirente'));
