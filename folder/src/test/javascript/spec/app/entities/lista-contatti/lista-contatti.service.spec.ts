...
import { IListaContatti, ListaContatti, EsitoChiamata } from 'app/shared/model/lista-contatti.model';
...
describe('Service Tests', () => {
    describe('ListaContatti Service', () => {
        ...
        let elemDefault: IListaContatti;
        beforeEach(() => {
            ...
            elemDefault = new ListaContatti(0, 'AAAAAAA', EsitoChiamata.ESEGUITA, 'AAAAAAA');
        });
