...
import { ImmobileComponent } from 'app/entities/immobile/immobile.component';
...
describe('Component Tests', () => {
    describe('Immobile Management Component', () => {
        let comp: ImmobileComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ImmobileComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.immobiles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
